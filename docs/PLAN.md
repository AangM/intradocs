...
| TA    | ✅ Technology Architecture (layer teknologi EA): impor Sparx XMI/CSV (pratinjau→terapkan, audit), katalog, halaman elemen dengan dampak/dependensi, tanya arsitektur deterministik + pencarian semantik KB WeKnora kedua; unit 9, integration 4, HTTP 5                                                                           | Impor langsung dari repositori Sparx (Pro Cloud/OSLC) ✗; layer Business/Data/Application ✗                                                                                                                                            |
